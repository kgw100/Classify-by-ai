...
HEX_LIST = ['0x00', '0x17', '0x20', '0x2F', '0x6D', '0x92', '0xA4', '0xD4' ,'0xE8', '0x2B',
          ...
          '0xE7', '0xEB', '0xEF', '0x7F', '0x80', '0x91', '0xBF', '0x30', '0x31', '0x36', 
          '0x38', '0x3A', '0x3C', '0x3E', '0x47', '0x63', '0x64', '0x65', '0x66', '0x69', 
          '0x6C', '0x72', '0x74', '0x76', '0x78', '0x79', '0xC1', '0x04', '0xFC', '0xFD',
...
dir_list = ['h264_fragment_trainingset', 'jpg_fragment_trainingset', 'png_fragment_trainingset', 'wav_fragment_trainingset', 'hwp_fragment_trainingset']


#test set
#dir_list = ['png_fragment_testset', 'h264_fragment_testset', 'pdf_fragment_testset','hwp_fragment_testset', 'jpg_fragment_testset', 'wav_fragment_testset']
dir_list = ['png_fragment_testset', 'h264_fragment_testset', 'hwp_fragment_testset', 'jpg_fragment_testset', 'wav_fragment_testset']
